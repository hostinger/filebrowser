...
// Phrase In-Context Editor (ICE) integration (HSTG-21088), following the
// convention used by hpanel/hcart/hwebsites (PHRASEAPP_CONFIG global,
// cdn.phrase.com editor script, [[__ __]] decorators).
//
...
// Hostinger Phrase account, from the hTranslate migration announcement
const phraseAccountId = "3b42d924cc735b83fa5b486acb7ed6b9";
// hTranslate > Manage Brand > WH Tools > Phrase Project ID
...
export function loadPhraseIce() {
  ...
  // never let ICE interfere with QA automation runs
  if (hasCookie("hostinger_qa_automation=1")) return;
